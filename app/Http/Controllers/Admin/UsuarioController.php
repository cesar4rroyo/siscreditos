...
class UsuarioController extends Controller
{
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = Usuario::listar($login,$nombre,$tipousuario_id);
        $lista            = $resultado->get();
        $cabecera         = array();
    ...
    public function index()
    {
        ...
        return view($this->folderview.'.admin')->with(compact('entidad', 'title', 'titulo_registrar', 'ruta','cboTiposUsuario'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $persona = Persona::all()->toArray();
        $cboPersona =  array('' => 'Seleccione una Persona') + Persona::getUsuarios()->pluck('full_name', 'id')->all();;
        $formData     = array('route' => $formData, 'class' => 'form-horizontal', 'id' => 'formMantenimiento'.$entidad, 'autocomplete' => 'off');
        $boton        = 'Registrar'; 
        return view($this->folderview.'.mant')->with(compact('usuario', 'formData', 'entidad', 'boton', 'cboTiposUsuario', 'listar', 'cboPersona'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $reglas = array(
            ...
            'persona_id'   => 'required|integer|exists:persona,id,deleted_at,NULL',
            );
    ...
    public function edit($id, Request $request)
    {
        ...
        $boton          = 'Modificar';
        $cboTiposUsuario  = array('' => 'Seleccione un Tipo de Usuario') + TipoUsuario::pluck('descripcion', 'id')->all();
        $cboPersona =  array('' => 'Seleccione una Persona') + Persona::get()->pluck('full_name', 'id')->all();;
        return view($this->folderview.'.mant')->with(compact('usuario', 'formData', 'entidad', 'boton', 'listar', 'cboTiposUsuario', 'cboPersona'));
    }
     /**
