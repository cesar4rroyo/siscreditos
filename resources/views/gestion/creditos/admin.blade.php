                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm form-group">
                                ...
                                {!! Form::date('fechainicio', date('Y-m-d'), ['class' => 'form-control input-xs', 'id' => 'fechainicio', 'onchange' => 'buscar(\'' . $entidad . '\')']) !!}
                            </div>
                            <div class="col-sm form-group">
                                {!! Form::label('fechafin', 'Fecha fin') !!}
                                {!! Form::date('fechafin', '', ['class' => 'form-control input-xs', 'id' => 'fechafin', 'onchange' => 'buscar(\'' . $entidad . '\')']) !!}
                            </div>
                            <div class="col-sm form-group">
